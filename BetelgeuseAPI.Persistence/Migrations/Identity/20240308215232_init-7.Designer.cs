...
namespace BetelgeuseAPI.Persistence.Migrations.Identity
{
    ...
    [Migration("20240308215232_init-7")]
    partial class init7
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BetelgeuseAPI.Domain.Auth.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "25178cbb-f158-4375-8915-4258276c7a61",
                            Name = "Admin",
                            NormalizedName = "ADMİN"
                        },
                        new
                        {
                            Id = "a90801b7-212f-41ad-b60a-df306eb00e0a",
                            Name = "Moderator",
                            NormalizedName = "MODERATOR"
                        },
                        new
                        {
                            Id = "ce8a6fc1-5796-4fc2-9c49-597b501fe95b",
                            Name = "Student",
            ...
            modelBuilder.Entity("BetelgeuseAPI.Domain.Auth.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ce8a6fc1-5796-4fc2-9c49-597b501fe95b",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "de405065-c724-4d18-94cd-4157b7b95894",
                        ...
                        new
                        {
                            Id = "a90801b7-212f-41ad-b60a-df306eb00e0a",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "837956f1-09cd-4c20-b785-2c232c778906",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "a90801b7-212f-41ad-b60a-df306eb00e0a",
                            RoleId = "a90801b7-212f-41ad-b60a-df306eb00e0a"
                        },
                        new
                        {
                            UserId = "ce8a6fc1-5796-4fc2-9c49-597b501fe95b",
                            RoleId = "ce8a6fc1-5796-4fc2-9c49-597b501fe95b"
                        });
                });
            ...
            modelBuilder.Entity("BetelgeuseAPI.Domain.Entities.Blogs", b =>
                {
                    ...
                    b.HasOne("BetelgeuseAPI.Domain.Entities.BlogImage", "BlogImage")
                        .WithOne("Blogs")
                        .HasForeignKey("BetelgeuseAPI.Domain.Entities.Blogs", "BlogImageID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
